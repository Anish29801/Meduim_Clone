...
export default function Sidebar() {
  ...
  const userNavigation = [
    ...
    { name: "Library", icon: BookOpenIcon, href: "/dashboard", current: false, private: true },
    { name: "Profile", icon: UserIcon, href: "/update", current: false, private: true },
    { name: "Stories", icon: NewspaperIcon, href: "/stories", current: false, private: true },
    // { name: "Stats", icon: ChartBarIcon, href: "#", current: false },
  ];

  const adminNavigation = [
    { name: "Dashboard", icon: HomeIcon, href: "/admin/dashboard", private: false },
    { name: "Library", icon: BookOpenIcon, href: "/dashboard", current: false, private: false },
    { name: "My Lists", icon: ShieldCheckIcon, href: "/articles/view", private: false },
    {
